...
public class funcoes_quiz {
    ...
    public static  String[] perguntasQuiz(Random random, ArrayList<Integer> indices) {
        ...
        String[][] perguntas = {
                ...
                {"Qual foi a civilização responsável pela construção de Machu Picchu?","a) Asteca","b) Egípcia","c) Inca","d) Maia","e) Fenícia","d","7"},
                {"Qual país foi o último a abolir oficialmente a escravidão nas Américas?","a) Cuba","b) Brasil","c) Haiti","d) Estados Unidos","e) República Dominicana","b","10"},
